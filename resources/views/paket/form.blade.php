...
<!-- Meta tag Keywords -->
<link href="{{asset('asset3/css/font-awesome.css')}}" rel="stylesheet">
<link href="{{asset('asset3/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script src="{{asset('asset3/js/jquery-2.2.3.min.js')}}"></script> 
<!-- //js -->
<!-- web-fonts -->
<link href="{{asset('asset3//fonts.googleapis.com/css?family=Roboto:300,400,500,700')}}" rel="stylesheet">
<link href="{{asset('asset3//fonts.googleapis.com/css?family=Poller+One')}}" rel="stylesheet">
<!-- //web-fonts --> 
</head>
		 ...
		 <div class="top-icons-agileits-w3layouts">
			...
			<div class="login-form">			
							<form action="{{route('paket.store')}}" method="POST" enctype="multipart/form-data">
								...
								<br/>
								<center>
								<a href="{{url('/')}}" style=" color: white; float: right; font-size: 15px; border-bottom: solid 1px;">Back</a>
								</center>
							</form>
						</div>
