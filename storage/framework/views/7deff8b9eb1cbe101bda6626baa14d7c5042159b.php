...
<head>
    ...
    <!-- //Meta tag Keywords -->
    <link rel="stylesheet" href="<?php echo e(asset('css/style.kirim.css')); ?>" type="text/css" media="all" /><!-- Style-CSS -->
</head>
    ...
    <div class="error-page">
      <div class="wrapper-full">
        ...
        src="<?php echo e(asset('images/logo.png')); ?>">
          ...
          <h2>Terima Kasih</h2>
          <h4>Paket anda akan segera sampai</h4>
          <p>silahkan tunggu</p>
          <!-- buttons -->
          <div class="buttons">
            <a href="<?php echo e(url('/')); ?>" class="btn brk-btn-bg brk-btn">
              Kembali
            </a>
...
</html><?php /**PATH C:\xampp2\htdocs\bukutamu\resources\views/layouts/afterKirim.blade.php ENDPATH**/ ?>